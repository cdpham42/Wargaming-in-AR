...
// Modified by Tremaine Ng from Microsoft's Holotoolkit ImpotExportAnchorManager
// July 31st, 2017
// Added checks for VR device presence, preventing the game from crashing
// when run in the Unity Editor and connecting to sharingService.exe
...
public class ImportExportAnchorManager : Singleton<ImportExportAnchorManager>
{
    ...
    protected override void Awake()
    {
        ...
        // We need to get our local anchor store started up if we are a hololens.
        if (UnityEngine.VR.VRDevice.isPresent)
        {
            currentState = ImportExportState.AnchorStore_Initializing;
            WorldAnchorStore.GetAsync(AnchorStoreReady);
        }
        // if we aren't, might as well destroy ourselves (
        else
        {
            Destroy(this);
        }
    ...
    private void Start()
    {
        Debug.Log("Import Export Start Function");
        #if UNITY_EDITOR
    ...
    private void Instance_SessionJoined(object sender, SharingSessionTracker.SessionJoinedEventArgs e)
    {
        ...
        Debug.Log("Before Invoke MarkSharingServiceReady");
        Invoke("MarkSharingServiceReady", 5);
        Debug.Log("After Invoke MarkSharingServiceReady");
    }
    ...
    private void InitRoomApi()
    {
        ...
        if (roomManager.GetRoomCount() == 0)
        {
            ...
            Debug.Log("UserID lowest: " + LocalUserHasLowestUserId());
    ...
    private void Update()
    {
        //Debug.Log("Entered \"Update\" on ImportExportAnchorManager");
        ...
        switch (currentState)
        {
            ...
            case ImportExportState.AnchorStore_Initialized:
                ...
                {
                    Debug.Log("starting InitRoomAPI");
                    InitRoomApi();
                    Debug.Log("finished InitRoomAPI");
                } //else { Debug.Log("entered AnchorStore_Initialized with sharingServiceReady == false"); }
                break;
    ...
    private bool AttachToCachedAnchor(string anchorName)
    {
        ...
        if (anchorStore != null)
        {
            ...
            Debug.Log("Tried to GetAllIds() from null anchorstore");
        }
