...
// Modified by Tremaine Ng from Microsoft's Holotoolkit TapToPlace
// July 31st, 2017
// Allows tapping to pick up and place an object with a SyncUnit script attached
...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    public class TapToPlaceUnit : MonoBehaviour, IInputClickHandler
    {
        ...
        protected virtual void Start()
        {
            ...
            {
                Debug.LogError("This script expects that you have a InputManager component in your scene.");
            }
            ...
            this.unit = GetComponent<SyncUnit>();
            if (this.unit == null)
            {
                Debug.LogError("Could not find SyncUnit Script for use by TapToPlaceUnit!");
            }
        }
        ...
        protected virtual void Update()
        {
            ...
            if (IsBeingPlaced)
            {
                ...
                if (Physics.Raycast(headPosition, gazeDirection, out hitInfo, 30.0f, LayerMask.GetMask("Board")))
                {
                    ...
                    {
                        //Debug.Log("before doMove" + unit.GetLocalPosition().ToString());
                        unit.DoMove(hitInfo.point, toQuat);
                        //Debug.Log("after doMove" + unit.GetLocalPosition().ToString());
        ...
        public virtual void OnInputClicked(InputEventData eventData)
        {
            ...
            if (!IsBeingPlaced)
            {
                inputManager.PushModalInputHandler(this.gameObject);
            } else
            {
