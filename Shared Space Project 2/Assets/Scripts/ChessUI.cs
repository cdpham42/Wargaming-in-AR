...
public class ChessUI : NetworkBehaviour
{
    /// <summary>
    ...
    void Update()
    {
        ...
        {
            CreateUnit(KeyQCommand.Command);
        }
        if (Input.GetKeyDown(KeyCode.W))
        {
            CreateUnit(KeyWCommand.Command);
        }
        if (Input.GetKeyDown(KeyCode.E))
        {
            CreateUnit(KeyECommand.Command);
        }
        if (Input.GetKeyDown(KeyCode.R))
        {
            CreateUnit(KeyRCommand.Command);
        }
        if (Input.GetKeyDown(KeyCode.T))
        {
            CreateUnit(KeyTCommand.Command);
        }
        if (Input.GetKeyDown(KeyCode.Y))
        {
            CreateUnit(KeyYCommand.Command);
        }
