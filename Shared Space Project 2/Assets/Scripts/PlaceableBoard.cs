...
// Modified by Tremaine Ng from HolotoolKit's TapToPlace
// July 31st, 2017
// Allows user to tap to place the board down
...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    public class PlaceableBoard : MonoBehaviour, IInputClickHandler
    {
        [Tooltip("Supply a friendly name for the anchor as the key name for the WorldAnchorStore.")]
        public string SavedAnchorFriendlyName = "BoardAnchor";
        ...
        /// <summary>
        /// Allows checking for lowest user ID
        /// </summary>
        protected ImportExportAnchorManager impExpAnchorManager;

        /// <summary>
        /// Manages gesture input event handlers
        /// use to push input focus stack
        /// </summary>
        ...
        protected virtual void Start()
        {
            ...
            impExpAnchorManager = ImportExportAnchorManager.Instance;
            if (impExpAnchorManager == null && UnityEngine.VR.VRDevice.isPresent)
            {
                Debug.LogError("This script expects that you have an ImportExportAnchorManager component in your scene.");
            }
            ...
            if (inputManager != null && anchorManager != null && spatialMappingManager != null)
            {
        ...
        protected virtual void Update()
        {
            ...
            if (IsBeingPlaced)
            {
                ...
                RaycastHit hitInfo;
                if (Physics.Raycast(headPosition, gazeDirection, out hitInfo, 30.0f, LayerMask.GetMask("Board")))
                {
                    ...
                    {
                        this.transform.SetPositionAndRotation(hitInfo.point, toQuat);
                    }
                }
            }
        }
        ...
        public virtual void OnInputClicked(InputEventData eventData)
        {
            ...
            // when selected, lock tap input to this object. When deselected, unlock. 
            ...
            if (IsBeingPlaced)
            {
                ...
                spatialMappingManager.CleanupObserver();    // stop observing and remove all mapping info
